    ...
    >
      ...
      <ul className="mt-4 flex flex-wrap gap-1.5">
        {project.highlights.map((h) => (
          <li
            key={h}
            className="rounded-md border border-white/[0.07] bg-white/[0.03] px-2.5 py-1 text-[11px] text-slate-400"
          >
            {h}
          </li>
        ))}
      ...
      <div className="mt-auto flex items-center gap-2 pt-5 text-sm font-medium text-slate-300">
